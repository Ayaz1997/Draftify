...
import { AlertTriangle, ArrowLeft, Printer, Edit } from 'lucide-react';
...
// Note: This component is now a client component to handle form state and live preview.
export default function TemplatePage({ params }: TemplatePageProps) {
  const router = useRouter();
  const { toast } = useToast();
  const template = useMemo(() => templates.find((t) => t.id === params.templateId), [params.templateId]);
